...
class PaperBook(Book):
    def __init__(self, name: str, author: str, pages: int):
        ...
        if isinstance(pages, int):
            ...
            raise ValueError("Укажите номер страницы в виде числа")
    ...
    def __init__(self, name: str, author: str, duration: float):
        ...
        if isinstance(duration, float):
            if duration > 0:
                ...
                raise ValueError(f'Неверно указана длительность аудио книги: {duration!r}')
        else:
            raise ValueError('Введите длительность')
...
if __name__ == "__main__":
    book = PaperBook("Defensible space", "Oskar Newman", 686)
    print(book)
    book_1 =AudioBook("Atomic Habits", "James Clear", 1005)
    print(book_1)